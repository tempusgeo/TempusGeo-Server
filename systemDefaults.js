...
/**
 * חגי דת אסלאם שמקובלים כימי חג דת לעובד מוסלמי בהקשר שכר/מנוחה בישראל — עיקרם שני החגים הגדולים (עיד אל-פיטר ועיד אל-אדחא),
 * ללא רמדאן, לילות קודש וכו' שלא מוגדרים כ"חג" לתעריף מיוחד כמו החגים הגדולים.
 */
const ISLAMIC_STATUTORY_HOLIDAYS_IL = ['עיד אל-פיטר', 'עיד אל-אדחא'];
